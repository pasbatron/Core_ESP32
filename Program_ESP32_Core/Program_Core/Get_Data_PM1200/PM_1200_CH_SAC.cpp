...
SoftwareSerial mySerialLora(TX_G27, RX_G26); // TX, RX
ModbusRTU mb;
...
void loop() {
  // data kwh
  readAndSendData(1, 3960, "CH_SAC", "PM_220V");

  // data kwh
  readAndSendData(2, 3960, "CH_SAC", "PM_200V");

  // data kwh
  readAndSendData(3, 3960, "CC_234", "PM_220V");

  // data kwh
  readAndSendData(4, 3960, "CC_234", "PM_200V");
